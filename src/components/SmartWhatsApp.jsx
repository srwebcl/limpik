...
const agentsConfig = {
    sales: {
        id: 'sales',
        phone: '56990728582',
        message: 'Hola, estoy interesado en cotizar un servicio de limpieza.',
        tooltip: 'Cotizar Ahora'
    },
    ethics: {
        id: 'ethics',
        phone: '56990728582',
        message: 'Hola, deseo realizar una consulta al Canal Ético.',
        tooltip: 'Canal Ético'
    },
    support: {
        id: 'support',
...
const SmartWhatsApp = () => {
    ...
    const handleClick = () => {
        const url = `https://wa.me/${agent.phone}?text=${encodeURIComponent(agent.message)}`;
